...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id 52199FC04F
	for <lists+tipc-discussion@lfdr.de>; Thu, 14 Nov 2019 07:44:04 +0100 (CET)
Received: from [127.0.0.1] (helo=sfs-ml-4.v29.lw.sourceforge.com)
	by sfs-ml-4.v29.lw.sourceforge.com with esmtp (Exim 4.90_1)
	(envelope-from <tipc-discussion-bounces@lists.sourceforge.net>)
	id 1iV8rI-0004nt-V4; Thu, 14 Nov 2019 06:44:00 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-4.v29.lw.sourceforge.com with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.90_1)
 (envelope-from <tuong.t.lien@dektech.com.au>) id 1iV8rH-0004nd-AR
 for tipc-discussion@lists.sourceforge.net; Thu, 14 Nov 2019 06:43:59 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=uOdaAifhwxxa6bFf9UcvFhM/IE+asSlKCykfQ5i/gRA=; b=d81GZk7wHShl+zsIpXjPYRkAl0
 cydvn+x08BaTfYpZZqbZBylywW+jr+9ulo/0EduO8jBRgnEdxXoBiU7vvIaUljYEQfdujCJRkz+PG
 PyfBK5calLTnV4KQUMmr9oR9z6Ua9qe2WUjCExIVLmpafymelAGs3w3A8pMuEqIUb+Pw=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=uOdaAifhwxxa6bFf9UcvFhM/IE+asSlKCykfQ5i/gRA=; b=BYatorEpc3h5F2vvMtfY1ubNya
 gTeAEEJrlzMA27bZ+nYL4GJ5CnxEWy6eaq7v1Px/swlWq5ZR/nS2ztYm4Y8IHWhoPZsuP2+RWWGOh
 2tj653PtHuqT879a1PEuavcRYqN5mr3Q66xN86ZFeKhG/3Q/RlvAKOpUmEjuH77GR4pE=;
Received: from f0-dek.dektech.com.au ([210.10.221.142]
 helo=mail.dektech.com.au)
 by sfi-mx-3.v28.lw.sourceforge.com with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.92.2)
 id 1iV8r8-00G2Al-8A
 for tipc-discussion@lists.sourceforge.net; Thu, 14 Nov 2019 06:43:54 +0000
Received: from localhost (localhost [127.0.0.1])
 by mail.dektech.com.au (Postfix) with ESMTP id B99104ACFB;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=dektech.com.au;
 ...
 1573713819; bh=yX/xQrCKP7SByec4hIHdBH9SS79Pn8ExNcGxju/Y+fk=; b=j
 cj2X2FqSSrz/FqnKZwZ4MqdY4Bbt3rptqX1C9c83R9UktX87CbWR5GbYKUHVQa1b
 t6wdZK/bEH0WVY5tadfqXPpi5I0z3pWR5YKXrIArx3O3lOG/Sjtvh2d2QssXS1OK
 FDabVKINrYvgtMFk7+dF1kr1435AEp8PtWGI+dC+zw=
X-Virus-Scanned: amavisd-new at dektech.com.au
Received: from mail.dektech.com.au ([127.0.0.1])
 by localhost (mail2.dektech.com.au [127.0.0.1]) (amavisd-new, port 10026)
 with ESMTP id XL3GssxDrxSN; Thu, 14 Nov 2019 17:43:39 +1100 (AEDT)
Received: from mail.dektech.com.au (localhost [127.0.0.1])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by mail.dektech.com.au (Postfix) with ESMTPS id 9C8504ACB1;
 Thu, 14 Nov 2019 17:43:39 +1100 (AEDT)
Received: from localhost.localdomain (unknown [14.161.14.188])
 (using TLSv1.2 with cipher ECDHE-RSA-AES128-SHA256 (128/128 bits))
 (No client certificate requested)
 by mail.dektech.com.au (Postfix) with ESMTPSA id C531D4AD01;
 Thu, 14 Nov 2019 17:43:38 +1100 (AEDT)
From: Tuong Lien <tuong.t.lien@dektech.com.au>
To: tipc-discussion@lists.sourceforge.net, jon.maloy@ericsson.com,
 maloy@donjonn.com, ying.xue@windriver.com
Date: Thu, 14 Nov 2019 13:43:31 +0700
Message-Id: <20191114064332.15061-2-tuong.t.lien@dektech.com.au>
...
X-Headers-End: 1iV8r8-00G2Al-8A
Subject: [tipc-discussion] [net-next 1/2] tipc: support in-order name
 publication events
...
v2: extend the sorting per publications, so guarantee a temporal order
even if users set their subscription filter to 'TIPC_SUB_PORTS'.
...
index 66a65c2cdb23..45a9ab539fdb 100644
...
@@ -244,6 +248,7 @@ static struct publication *tipc_service_insert_publ(struct net *net,
...
@@ -277,6 +282,17 @@ static struct publication *tipc_service_remove_publ(struct service_range *sr,
 	return NULL;
 }
...
@@ -286,36 +302,51 @@ static void tipc_service_subscribe(struct tipc_service *service,
