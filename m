References: <20191021041537.16788-1-hoang.h.le@dektech.com.au>
In-Reply-To: <20191021041537.16788-1-hoang.h.le@dektech.com.au>
...
x-ms-office365-filtering-correlation-id: fa66f338-86c1-4507-84ce-08d756777e98
x-ms-traffictypediagnostic: CH2PR15MB3733:
x-ld-processed: 92e84ceb-fbfd-47ab-be52-080c6b87953f,ExtAddr
x-microsoft-antispam-prvs: <CH2PR15MB3733732AE140A5C40A16706D9A690@CH2PR15MB3733.namprd15.prod.outlook.com>
x-ms-oob-tlc-oobclassifiers: OLM:183;
x-forefront-prvs: 0197AFBD92
x-forefront-antispam-report: SFV:NSPM;
 SFS:(10009020)(4636009)(39860400002)(376002)(366004)(136003)(346002)(396003)(189003)(199004)(13464003)(102836004)(66946007)(76116006)(64756008)(66446008)(14444005)(5024004)(66556008)(66476007)(2201001)(229853002)(316002)(110136005)(256004)(25786009)(305945005)(7696005)(44832011)(74316002)(76176011)(2501003)(55016002)(6436002)(99286004)(2906002)(7736002)(8936002)(53546011)(9686003)(30864003)(3846002)(486006)(66066001)(11346002)(8676002)(5660300002)(81156014)(446003)(14454004)(81166006)(6116002)(6506007)(6246003)(478600001)(33656002)(71200400001)(26005)(476003)(186003)(52536014)(71190400001)(86362001);
 DIR:OUT; SFP:1101; SCL:1; SRVR:CH2PR15MB3733;
...
x-microsoft-antispam-message-info: 
x-ms-exchange-transport-forked: True
MIME-Version: 1.0
X-OriginatorOrg: ericsson.com
X-MS-Exchange-CrossTenant-Network-Message-Id: fa66f338-86c1-4507-84ce-08d756777e98
X-MS-Exchange-CrossTenant-originalarrivaltime: 21 Oct 2019 22:39:11.9517 (UTC)
X-MS-Exchange-CrossTenant-fromentityheader: Hosted
X-MS-Exchange-CrossTenant-id: 92e84ceb-fbfd-47ab-be52-080c6b87953f
X-MS-Exchange-CrossTenant-mailboxtype: HOSTED
X-MS-Exchange-CrossTenant-userprincipalname: WH+7PDv2NVpewmRcj6THo9IqCf0dLBvAfVa7t4nHHz/aJi5isATq3RtOTrptHnhGq1wyZa/xV+I/fCejeohEeQ==
...
X-Spam-Report: Spam Filtering performed by mx.sourceforge.net.
 ...
 trust [40.107.68.43 listed in list.dnswl.org]
...
X-Headers-End: 1iMgYI-00GFsV-Oi
...
Hi Hoang,
Just some improvements to (my own) log message text below.  Then you can go ahead and add "acked-by" from me.
...
> cluster id, this is deemed sufficient proof that the peer node in question is in a
...
s/should be given more freedom to shortcut the lower protocol than other protocols/ 
   we think it can justified to allow it to shortcut the lower protocol layers./g
> 
> Regarding traceability, we should notice that since commit 6c9081a3915d
> ("tipc: add loopback device tracking") it is possible to follow the node internal
...
> +97,10 @@ static void tipc_disc_init_msg(struct net *net, struct sk_buff *skb,
...
> 
> @@ -242,7 +249,8 @@ void tipc_disc_rcv(struct net *net, struct sk_buff
> *skb,
...
> c8f6177dd5a2..780b726041dd 100644
> --- a/net/tipc/node.c
> +++ b/net/tipc/node.c
> @@ -45,6 +45,8 @@
>  #include "netlink.h"
...
> @@ -361,12 +372,16 @@ static void tipc_node_write_unlock(struct
> tipc_node *n)  }
> 
...
> @@ -979,7 +1013,7 @@ u32 tipc_node_try_addr(struct net *net, u8 *id,
> u32 addr)
> 
...
>  {
> @@ -998,7 +1032,8 @@ void tipc_node_check_dest(struct net *net, u32
> addr,
>  	*dupl_addr = false;
>  	*respond = false;
> 
...
> @@ -1439,6 +1520,7 @@ int tipc_node_xmit(struct net *net, struct
> sk_buff_head *list,
...
>  	int rc;
> 
> @@ -1455,6 +1537,16 @@ int tipc_node_xmit(struct net *net, struct
> sk_buff_head *list,
>  		return -EHOSTUNREACH;
>  	}
> 
...
> a/net/tipc/node.h b/net/tipc/node.h index 291d0ecd4101..2557d40fd417
> 100644
> --- a/net/tipc/node.h
> +++ b/net/tipc/node.h
...
>  			  struct tipc_media_addr *maddr,
>  			  bool *respond, bool *dupl_addr);
>  void tipc_node_delete_links(struct net *net, int bearer_id); @@ -92,7 +92,7
...
> tipc_nl_node_dump(struct sk_buff *skb, struct netlink_callback *cb); diff --git
