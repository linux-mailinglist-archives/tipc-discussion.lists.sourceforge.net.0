...
Received: from lists.sourceforge.net (lists.sourceforge.net [216.105.38.7])
	by mail.lfdr.de (Postfix) with ESMTPS id DCF1F12A023
	for <lists+tipc-discussion@lfdr.de>; Tue, 24 Dec 2019 11:32:18 +0100 (CET)
Received: from [127.0.0.1] (helo=sfs-ml-2.v29.lw.sourceforge.com)
	by sfs-ml-2.v29.lw.sourceforge.com with esmtp (Exim 4.90_1)
	(envelope-from <tipc-discussion-bounces@lists.sourceforge.net>)
	id 1ijhU5-0007lf-GF; Tue, 24 Dec 2019 10:32:13 +0000
Received: from [172.30.20.202] (helo=mx.sourceforge.net)
 by sfs-ml-2.v29.lw.sourceforge.com with esmtps
 (TLSv1.2:ECDHE-RSA-AES256-GCM-SHA384:256) (Exim 4.90_1)
 (envelope-from <tuong.t.lien@dektech.com.au>) id 1ijhU3-0007lX-56
 for tipc-discussion@lists.sourceforge.net; Tue, 24 Dec 2019 10:32:11 +0000
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
 ...
 bh=2sAtcLd9ql/qkYCKl0PeH9dfEznGjM9d02ZQegtNuuE=; b=fWBK+sIYMgJ94DvsQUY+sHXoMF
 JkTAYEcejoyDvDaM8WaFgmJB2PZiIi87v/zVGHgizFWkSvSRr2blv4xkGIXsnR3T6yuJ5RWR20a+U
 zjfNGpDZoWbSA7kfYPWuKgajme8JaVVDx1MWLGBTn1lDHxjr33xOrs4uTNNcgF6H/6Xw=;
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=sf.net; s=x
 ...
 bh=2sAtcLd9ql/qkYCKl0PeH9dfEznGjM9d02ZQegtNuuE=; b=Ciu9uC3zY5a1cj1hFTsrpvIgrO
 Ik7TS8Hry6TkQbVYfB49EswUrQxOSq0uzNmE0Jf5qP4+Mq07MnxXH6Eg4yOw2hts0LdIwYj8JXv2t
 RLz6S3asrCBUMzjR54SZ/nNWIDQRaX0zDi+g8Pa4i/AX05fEk+PO6wWE6ks68RwPL5v0=;
...
Received: from localhost (localhost [127.0.0.1])
 by mail.dektech.com.au (Postfix) with ESMTP id 25E7D4C33C;
 Tue, 24 Dec 2019 21:31:56 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=dektech.com.au;
 ...
 :received:received; s=mail_dkim; t=1577183516; bh=4HBir9IUFbQ+Ah
 fthsnDDnBhOpQTBL72CqX3tySKD+k=; b=My43/F1Cxgg6ft3LKTNew0zaNQ6CnN
 tTJ/QwkySiBTVONDAXPSV86QNjMx/dpJyufEsWhGb4Q6PePD5q7XlCMaolAh+0bO
 TjDRTFgYwxyNzGT2Kg4jzEX+hXra6z25XVIfS9flNtbK3vVZsIsbRllkGk2wDoy2
 PjhmFw9cWwWzo=
X-Virus-Scanned: amavisd-new at dektech.com.au
Received: from mail.dektech.com.au ([127.0.0.1])
 by localhost (mail2.dektech.com.au [127.0.0.1]) (amavisd-new, port 10026)
 with ESMTP id rCASDYzeWFzk; Tue, 24 Dec 2019 21:31:56 +1100 (AEDT)
Received: from mail.dektech.com.au (localhost [127.0.0.1])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by mail.dektech.com.au (Postfix) with ESMTPS id AF40F4C1D0;
 Tue, 24 Dec 2019 21:31:54 +1100 (AEDT)
Received: from VNLAP288VNPC (unknown [14.161.14.188])
 (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
 (No client certificate requested)
 by mail.dektech.com.au (Postfix) with ESMTPSA id 7E41F4C33C;
 Tue, 24 Dec 2019 21:31:53 +1100 (AEDT)
...
In-Reply-To: <DB6PR07MB4277097FFD0C8F9EFB178CB09A2E0@DB6PR07MB4277.eurprd07.prod.outlook.com>
Date: Tue, 24 Dec 2019 17:31:51 +0700
Message-ID: <078301d5ba45$5c7b9390$1572bab0$@dektech.com.au>
MIME-Version: 1.0
X-Mailer: Microsoft Outlook 16.0
Thread-Index: AQIntNtoljVhP8PHUAfIvZGomvjlmAMhHeh0AcUMOeQCNU17pwHnfMznAcm2UFSmzrt3EA==
...
X-Headers-End: 1ijhTx-00E0Pc-S2
...
This also partially solves the "forward secrecy" issue since a completely new/independent key is entered that a sniffer has no way to derive it from the previous ones. Let's say this is both authentication & forward secrecy achieved simply through user (or the framework)...
...
[Tuong]: The sound is like the "per-node-pair key" mode, but we decided to not support from the beginning...? Particularly, for TX we always use the own key (either the per node or cluster key) instead of looking for the peer/destination's key... In fact, there's an obstacle to this mode in terms of broadcast or multicast that requires a commonly different key or fallback to replicast...
